...
class PluginResult:
    ...
    """
    def __init__(self, text_result, xml_result, raw_result=None):
        """
        ...
        @type raw_result: [str]
        @param raw_result: Raw unformatted data arrays.
        This has been added by Zapletal and Hoeyng for the HFT TLS-Crawler
        """
